  ...
  legalPages: {
    ...
    terms: {
      ...
      sections: [
        ...
        { heading: "Getting in touch", body: "Questions about these terms go to hr@zedventures.com, or by post to ZEDventures Inc., 1762 Technology Drive, San Jose, CA 95110. [CONFIRM — whether legal notices should go to a different address than general enquiries.]" },
      ],
    },
  },
  nav: {
  ...
  legalPages: {
    ...
    terms: {
      ...
      sections: [
        ...
        { heading: "Nous contacter", body: "Toute question relative aux présentes conditions peut être adressée à hr@zedventures.com, ou par courrier à ZEDventures Inc., 1762 Technology Drive, San Jose, CA 95110. [À CONFIRMER — si les notifications juridiques doivent être adressées à une autre adresse que les demandes générales.]" },
      ],
    },
  },
  nav: {
