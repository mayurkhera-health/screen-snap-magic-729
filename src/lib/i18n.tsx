...
const en = {
  ...
  contact: {
    ...
    page: {
      ...
      emailLabel: "Email",
      email: "hello@zedventures.com",
      phoneLabel: "Phone",
      phone: "+1 (408) 555-0134",
      officesEyebrow: "Our offices",
      addressSoon: "Full address available on request",
      offices: [
        { city: "San Jose", region: "California, USA" },
        { city: "Dallas", region: "Texas, USA" },
...
const fr: Copy = {
  ...
  contact: {
    ...
    page: {
      ...
      addressSoon: "Adresse complète disponible sur demande",
      offices: [
        { city: "San Jose", region: "Californie, États-Unis" },
        { city: "Dallas", region: "Texas, États-Unis" },
        { city: "Hyderabad", region: "Inde" },
      ],
    },
  },
  footer: {
