...
const en = {
  ...
  wheel: {
    ...
    heading: "Everything around one core",
    centerTitle: "Systems that hold up in production",
    centerSub: "Every capability serves a single goal — software that works in the real world.",
    items: [
      { title: "Generative AI Services", desc: "LLM applications and agents grounded in your enterprise data, built to run in production." },
      { title: "Data Science & ML", desc: "Predictive models and machine-learning pipelines that turn raw data into decisions." },
      { title: "Data Management", desc: "Warehouses, data lakes, and governance that make data trustworthy and usable." },
      { title: "Analytics & BI", desc: "Dashboards and reporting leadership can act on — in real time." },
      { title: "Quality Engineering", desc: "Automated testing, performance, and compliance built into every release." },
      { title: "DevSecOps", desc: "Secure, automated delivery pipelines from commit to production." },
      { title: "Cloud & Modernization", desc: "Cloud migration, re-architecture, and cost-efficient infrastructure." },
      { title: "GIS & Geospatial", desc: "Spatial data, mapping, and location analytics for risk and operations." },
      { title: "Guidewire", desc: "PolicyCenter, BillingCenter, and ClaimCenter — implementation through cloud." },
      { title: "SAP", desc: "S/4HANA, BTP, and Fiori delivered with clean-core discipline." },
      { title: "Product Engineering", desc: "Full-cycle design, development, and delivery of software products." },
      { title: "Offshore & Nearshore", desc: "Dedicated engineering teams in India and the Americas, one engagement model." },
    ],
  },
  caseStudies: {
...
const fr: Copy = {
  ...
  wheel: {
    eyebrow: "Carte des expertises",
    heading: "Tout autour d'un même noyau",
    centerTitle: "Des systèmes prêts pour la production",
    centerSub: "Chaque expertise sert un seul objectif — des logiciels qui fonctionnent dans le monde réel.",
    items: [
      { title: "Services d'IA générative", desc: "Applications LLM et agents ancrés dans vos données d'entreprise, conçus pour la production." },
      { title: "Science des données et ML", desc: "Modèles prédictifs et pipelines d'apprentissage automatique qui transforment les données en décisions." },
      { title: "Gestion des données", desc: "Entrepôts, lacs de données et gouvernance pour des données fiables et exploitables." },
      { title: "Analytique et BI", desc: "Des tableaux de bord et rapports exploitables par la direction — en temps réel." },
      { title: "Ingénierie qualité", desc: "Tests automatisés, performance et conformité intégrés à chaque livraison." },
      { title: "DevSecOps", desc: "Pipelines de livraison sécurisés et automatisés, du commit à la production." },
      { title: "Infonuagique et modernisation", desc: "Migration infonuagique, réarchitecture et infrastructure rentable." },
      { title: "SIG et géospatial", desc: "Données spatiales, cartographie et analyse de localisation pour le risque et les opérations." },
      { title: "Guidewire", desc: "PolicyCenter, BillingCenter et ClaimCenter — de l'implantation à l'infonuagique." },
      { title: "SAP", desc: "S/4HANA, BTP et Fiori livrés selon une discipline « clean core »." },
      { title: "Ingénierie produit", desc: "Conception, développement et livraison complets de produits logiciels." },
      { title: "Offshore et nearshore", desc: "Équipes d'ingénierie dédiées en Inde et dans les Amériques, un seul modèle d'engagement." },
    ],
  },
  caseStudies: {
