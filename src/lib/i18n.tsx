...
const en = {
  ...
  contact: {
    ...
    sendFailedBody: "Something went wrong on our side, so nothing was sent. Try again, or write to us directly — your message is kept below either way.",
    retry: "Try again",
...
const fr: Copy = {
  ...
  contact: {
    ...
    sendFailedBody: "Un problème de notre côté : rien n'a été envoyé. Réessayez, ou écrivez-nous directement — votre message est conservé dans tous les cas.",
    retry: "Réessayer",
